...
class Web3Client {
  ...
  /// Some ethereum nodes support an event channel over websockets. Web3libdart
  ...
  ///
  /// {@template web3libdart:filter_streams_behavior}
  ...
  /// transaction.
  ///
  /// {@macro web3libdart:filter_streams_behavior}
  /// See also:
  /// - [hexToBytes] and [hexToInt], which can transform hex strings into a byte
  /// or integer representation.
