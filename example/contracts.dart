...
To generate contract classes, add a dependency on web3libdart and build_runner.
...
Future<void> main() async {
  ...
  // read the contract abi and tell web3libdart where it's deployed (contractAddr)
