...
[![pub package](https://img.shields.io/pub/v/web3libdart.svg)](https://pub.dartlang.org/packages/web3libdart)

Fork from [web3dart](https://github.com/xclud/web3dart) version 2.3.5
...
If you want to integrate `web3libdart` with other wallet providers, you can implement
...
listen for events emitted by smart contracts. See [this file](https://github.com/simolus3/web3libdart/blob/development/example/contracts.dart)
for an example.

### Dart Code Generator

By using [Dart's build system](https://github.com/dart-lang/build/), web3libdart can
...
[tracker]: https://github.com/simolus3/web3libdart/issues/new
