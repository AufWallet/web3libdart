/// Support for using web3libdart with browser clients such as MetaMask.
///
/// ## Example
///
/// ```dart
...
///
/// import 'package:web3libdart/browser.dart';
...
///
///   final message = Uint8List.fromList(utf8.encode('Hello from web3libdart'));
